    ...
    <div className="min-h-screen w-full flex items-center justify-center m-0 overflow-hidden font-['Fredoka'] select-none">
      {!gameStarted && (
        ...
        >
          ...
          <button
            onClick={startGame}
            style={{ backgroundImage: "url('./img/button.jpeg')" }}
            className="w-65 h-20 bg-cover bg-center rounded-4xl 
      ...
      {gameStarted && (
        <div className="flex flex-col items-center animate-fade-in px-4">
          <div
          style={{ backgroundImage: "url('./img/button.jpeg')" }}
            className="w-45 h-13  bg-cover bg-center rounded-4xl 
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <button
              ...
              style={{ backgroundImage: "url('./img/button.jpeg')" }}
              className="w-40 h-14  bg-cover bg-center rounded-3xl shadow-lg font-bold text-2xl text-[#E6DED1] active:scale-95 transition-transform cursor-pointer"
            >
              Resolver
            </button>
            <button
